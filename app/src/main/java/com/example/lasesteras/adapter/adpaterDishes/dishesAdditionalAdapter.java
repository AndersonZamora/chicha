...
public class dishesAdditionalAdapter extends RecyclerView.Adapter<dishesAdditionalAdapter.dishesAdapterViewHolder> {
    ...
    public dishesAdditionalAdapter(Context mContext, List<dishesModel> models, List<dishesModel> listModels, FragmentManager parentFragmentManager) {
