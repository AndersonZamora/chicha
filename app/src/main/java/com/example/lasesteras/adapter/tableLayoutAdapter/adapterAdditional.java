...
public class adapterAdditional extends RecyclerView.Adapter<adapterAdditional.viewHolder> {
    ...
    public adapterAdditional(List<dishesModel> modelClasses, List<dishesModel> listOrders, Context mContext, FragmentManager parentFragmentManager) {
